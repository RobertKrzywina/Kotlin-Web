...
class Constants {
    ...
    class User {
        companion object {
            ...
            const val MESSAGE_LENGTH_FIRST_NAME = "Title should have from 2 to 30 characters"
            const val MESSAGE_LENGTH_LAST_NAME = "Title should have from 2 to 30 characters"
